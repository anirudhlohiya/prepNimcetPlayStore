...
import com.anirudh.prepnimcet.databinding.FragmentArticleBinding
...
class ArticleFragment : Fragment() {
    ...
    private lateinit var articleAdapter: com.anirudh.prepnimcet.ArticleAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        blogList= ArrayList()
        articleAdapter= com.anirudh.prepnimcet.ArticleAdapter(blogList)
        binding?.recyclerview?.adapter =articleAdapter

        fetchBlogData()
        articleAdapter.setOnItemClickListener(object :
            com.anirudh.prepnimcet.ArticleAdapter.OnItemClickListener{
